...
export default class AuthPageTripcare {
    ...
    static getRememberMeCheckBox(): Locator { return browserDetails.page.locator("#rememberMe-input") }

    static getDashboardHeader(): Locator { return browserDetails.page.locator("#yourRidesForm") }
}
